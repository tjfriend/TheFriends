...
<div class="w3-row" style="padding-left: 30px; padding-right: 30px; padding-top: 40px" align="center">
	<form action="/qna/make" method="post">
		...
		<div class="table-responsive" align="center">
			...
			<textarea rows="10" cols="100" style="width: 50%; resize: none;"
				placeholder="CONTENT" name="content" required="required"></textarea>
			<br />
			<br /> <input type="submit" class="btn btn-default" value="작성하기" />&nbsp;&nbsp;
			<input type="button" class="btn btn-default" value="취소"
				onclick="javascript:location.href='/qna/list'" />
		</div>
	</form>
</div>