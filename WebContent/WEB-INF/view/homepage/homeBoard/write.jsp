...
<h3 class="w3-text-grey" style="margin-top: 50px" align="center">Upload</h3>

<div class="w3-row"
	style="padding-left: 30px; padding-right: 30px; padding-top: 20px"
	align="center">
	<form action="/homeBoard/upload/${id }" method="post"
		...
		<textarea rows="3" cols="10" style="width: 50%; resize: none;"
			placeholder="CONTENT" required="required" name="content"></textarea>
		<br /> <br />  <input
