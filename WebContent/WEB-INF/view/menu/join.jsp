	...
	<form>
		...
		<div class="form-group">
			<div class="w3-hide-large">
				...
				<input type="text" id="join_id_s" name="join_id_s" class="form-control" style="width: 35%" placeholder="6자리 이상"/>
				<font id="idcheck_s"></font>
			</div>
			<div class="w3-hide-small w3-hide-medium">
				<label for="join_id" style="width: 15%"><font size="4">ID</font></label><br/>
				<input type="text" id="join_id" name="join_id" class="form-control" style="width: 20%" placeholder="6자리 이상"/>
				<font id="idcheck"></font>
			</div>
		</div>
		<div class="form-group" align="center">
			<div class="w3-hide-large">
				<label for="join_password_s" style="width: 30%"><font size="4">Password</font></label><br/>
				<input type="password" id="join_password_s" name="join_password_s" class="form-control" style="width: 35%" placeholder="8자리이상, 숫자 1개이상 포함">
			</div>
			<div class="w3-hide-small w3-hide-medium">
				<label for="join_password" style="width: 15%"><font size="4">Password</font></label><br/>
				<input type="password" id="join_password" name="join_password" class="form-control" style="width: 20%" placeholder="8자리이상, 숫자 1개이상 포함"/>
			</div>
		</div>
		<div class="form-group" align="center">
			<div class="w3-hide-large">
				<label for="name_s" style="width: 30%"><font size="4">Name</font></label>
				<input type="text" id="name_s" name="name_s" class="form-control" style="width: 35%" placeholder="Name"/>
			</div>
			<div class="w3-hide-small w3-hide-medium">
				<label for="name" style="width: 15%"><font size="4">Name</font></label>
				<input type="text" id="name" name="name" class="form-control" style="width: 20%" placeholder="Name"/>
			</div>
		</div>
		<div class="form-group" align="center">
			<div class="w3-hide-large">
		...
		<div class="form-group" align="center">
			<div class="w3-hide-large">
				...
				<input type="text" id="email_s" name="email_s" style="width: 25%; height: 33px; border: 1px solid #ccc; border-radius: 5px; padding-left: 10px"
							placeholder="Email"/>
				<label>@</label>
				<input type="text" style="width: 25%; height: 33px; border: 1px solid #ccc; border-radius: 5px; padding-left: 10px" id="email2_s" name="email2_S" placeholder="직접입력"/>
			...
			<div class="w3-hide-small w3-hide-medium">
				...
				<input type="text" id="email" name="email" style="width: 10%; height: 33px; border: 1px solid #ccc; border-radius: 5px; padding-left: 10px"
							placeholder="Email"/>
				<label>@</label>
				<input type="text" style="width: 10%; height: 33px; border: 1px solid #ccc; border-radius: 5px; padding-left: 10px" id="email2" name="email2" placeholder="직접입력"/>
		...
		<div class="form-group" align="center">
			<div class="w3-hide-large">
				...
				<input type="text" id="recommender_s" name="recommender_s" class="form-control" style="width: 35%; padding-left: 10px" placeholder="recommender"/>
				<p>추천인 입력시 500 잣 증정<p>
			</div>
			<div class="w3-hide-small w3-hide-medium">
				<label for="recommender" style="width: 15%"><font size="4">Recommender</font></label><br/>
				<input type="text" id="recommender" name="recommender" class="form-control" style="width: 20%; padding-left: 10px" placeholder="recommender"/>
				<p>추천인 입력시 500 잣 증정<p>
			</div>
		</div>
		<div class="form-group" align="center">
			<div class="w3-hide-large">
				<input type="button" id="submit_s" value="Join" style="width: 35%; background-color: #4CAF50; color: white; padding: 14px 20px; border: none; border-radius: 4px; cursor: pointer;"/>
			</div>
			<div class="w3-hide-small w3-hide-medium">
				<input type="button" id="submit" value="Join" style="width: 15%; background-color: #4CAF50; color: white; padding: 14px 20px; border: none; border-radius: 4px; cursor: pointer;"/>
			</div>
		</div>
