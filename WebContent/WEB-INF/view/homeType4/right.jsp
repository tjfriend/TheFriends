...
<div class="w3-col l4">
	...
	<div class="w3-card-2 w3-margin w3-margin-top">
		...
		<div class="w3-container w3-white">
			...
			<p>Just me, myself and I, exploring the universe of uknownment. I
				have a heart of love and a interest of lorem ipsum and mauris neque
				quam blog. I want to share my world with you.</p>
		</div>
	</div>
	<hr>
	...
	<div class="w3-card-2 w3-margin">
		...
		<ul class="w3-ul w3-hoverable w3-white">
			<li class="w3-padding-16"><img src="/w3images/workshop.jpg"
				...
				<span class="w3-large">Lorem</span><br> <span>Sed mattis
					nunc</span></li>
			...
			<li class="w3-padding-16 w3-hide-medium w3-hide-small"><img
				src="/w3images/rock.jpg" alt="Image" class="w3-left w3-margin-right"
				style="width: 50px"> <span class="w3-large">Mingsum</span><br>
		...
		<div class="w3-container w3-white">
			<p>
				<span class="w3-tag w3-black w3-margin-bottom">Travel</span> <span
					...
					York</span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom">London</span>
