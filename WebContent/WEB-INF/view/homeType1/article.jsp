...
<div class="w3-container w3-padding-large" style="margin-bottom: 32px">
	...
	<p>Just me, myself and I, exploring the universe of unknownment. I
		have a heart of love and an interest of lorem ipsum and mauris neque
		quam blog. I want to share my world with you. Praesent tincidunt sed
	...
	<p>
		<button
			class="w3-btn w3-dark-grey w3-padding-large w3-margin-top w3-margin-bottom">
...
<div class="w3-container w3-padding-large w3-grey">
	...
	<form action="form.asp" target="_blank">
		...
		<button type="submit" class="w3-btn w3-padding-large w3-margin-bottom">
		...
		<div class="w3-third">
			...
			<ul class="w3-ul w3-hoverable">
				<li class="w3-padding-16"><img src="/w3images/workshop.jpg"
					...
					class="w3-large">Lorem</span><br> <span>Sed mattis nunc</span></li>
				<li class="w3-padding-16"><img src="/w3images/gondol.jpg"
					class="w3-left w3-margin-right" style="width: 50px"> <span
					class="w3-large">Ipsum</span><br> <span>Praes tinci sed</span></li>
			</ul>
		</div>
